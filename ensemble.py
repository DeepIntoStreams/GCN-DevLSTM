...
if __name__ == "__main__":
    ...
    parser.add_argument('--dual-dir', default=None)
    ...
    if arg.dual_dir is not None:
        with open(os.path.join(arg.dual_dir, 'epoch1_test_score.pkl'), 'rb') as r5:
            r5 = list(pickle.load(r5).items())

    right_num = total_num = right_num_5 = 0

    if arg.joint_motion_dir is not None and arg.bone_motion_dir is not None and arg.dual_dir is not None:
        arg.alpha = [0.7, 0.7, 0.3, 0.3, 0.7]
    ...
    elif arg.joint_motion_dir is not None and arg.bone_motion_dir is not None:
