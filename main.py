...
def get_parser():
    ...
    parser = argparse.ArgumentParser(description='GCN-DevLSTM')
    ...
    parser.add_argument(
        '--config',
        default='./config/ntu_sub/train_joint.yaml',
    ...
    parser.add_argument(
        '--seed',
        type=int,
        default=1,#random.randrange(200),
        help='random seed')
    parser.add_argument(
        '--log-interval',
        type=int,
    ...
    parser.add_argument(
        ...
        type=str,
        default='None',
        help='[None, dual_graph, spatial] graph; default None')
    
    parser.add_argument(
        '--bone',
        type=str2bool,
        default=False,
        help='use bone; default false')
